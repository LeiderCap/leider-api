...
export async function POST(req: NextRequest) {
  try {
    ...
    if (error) {
      console.error('investor_stack_inquiries insert error:', error);
    ...
    console.error('Unexpected error in investor-stack-request:', message);
