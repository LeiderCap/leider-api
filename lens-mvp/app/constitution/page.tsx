...
export const metadata: Metadata = {
  ...
  description:
    'The governing principles behind The Lens™ and Transformation Intelligence™. 82 principles across 9 categories — each versioned, citable, and machine-readable. Now includes Book V — The Future Firm™, Book VI — Unlock Science™, Book II — Enterprise Intelligence Architecture™, and Book VII — Enterprise Value Architecture™.',
};
