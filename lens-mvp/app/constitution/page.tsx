    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="border-b border-slate-200 bg-white px-6 py-16 text-center">
        ...
        <p className="mt-3 mx-auto max-w-xl text-sm italic text-slate-400">
          Now includes TI-063 — Intellectual Property Naming Principle™ (IPNP™): Trademark the frameworks. Describe the tools. Constitutional naming governance is now complete: TI-063 (framework vs. tool?) → TI-048 (trademark?) → TI-054 (how to write it?). 125 principles, 9 books, self-governing constitution.
        </p>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-lg border border-slate-300 bg-white px-8 py-6">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <p className="text-xs font-semibold text-slate-500">Version 5.0 &nbsp;|&nbsp; 125 Principles &nbsp;|&nbsp; 9 Books &nbsp;|&nbsp; Self-Governing Constitution</p>
