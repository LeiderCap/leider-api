    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="border-b border-slate-200 bg-white px-6 py-16 text-center">
        ...
        <p className="mt-3 mx-auto max-w-xl text-sm italic text-slate-400">
          Now includes TI-063 — Intellectual Property Naming Principle™ (IPNP™): Trademark the frameworks. Describe the tools. Constitutional naming governance is now complete: TI-063 (framework vs. tool?) → TI-048 (trademark?) → TI-054 (how to write it?). 133 principles, 9 books, self-governing constitution.
        </p>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-lg border border-slate-300 bg-white px-8 py-6">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <p className="text-xs font-semibold text-slate-500">Version 5.0 &nbsp;|&nbsp; 133 Principles &nbsp;|&nbsp; 9 Books &nbsp;|&nbsp; Self-Governing Constitution</p>
      ...
      <section className="mx-auto max-w-4xl px-6 pt-12 pb-0">
        <div className="mb-10 rounded-xl border-2 border-slate-300 bg-slate-50 p-8">
          ...
          <div className="space-y-3">
            {principles.filter(p => ['TI-044', 'TI-078', 'TI-079'].includes(p.id)).map((p) => (
          ...
          <p className="mt-4 text-xs text-slate-400">Book I foundational principles TI-001 through TI-011 establish the constitutional framework. TI-044 formalizes the economic law that unifies them. TI-048 — TI-049 establish the Constitutional Governance standard. TI-078 — Principle of Enterprise Evolution™ is the foundational proposition of Opportunity Science™. TI-079 — Principle of Enterprise Capability™ defines enterprise capability as the primary unit of progress.</p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 pt-12 pb-0">
        <div className='mb-10'>
          ...
          <p className='text-sm text-gray-500 mb-1'>
            The governance layer that makes enterprise intelligence explainable, measurable, and continuously connected to value creation.
          </p>
          <p className='text-xs text-gray-400 italic mb-4'>
            Meaning without authority creates ambiguity. Authority without evidence creates opinion. Evidence without accountability creates inaction. Accountability without decision rights creates paralysis. Decision rights without value create bureaucracy.
          </p>
          <div className="space-y-3">
            {principles.filter(p => p.id === 'TI-070').map((p) => (
              <div key={p.id} className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-5 py-3">
                <div className="flex items-center gap-3">
                  <span className="font-mono text-sm font-bold text-slate-700">{p.id}</span>
                  <span className="text-sm font-semibold text-slate-800">{p.name}</span>
      ...
      {/* Book XIX — Enterprise Value Architecture™ */}
      <section className="mx-auto max-w-4xl px-6 pt-12 pb-0">
        <div className='mb-10'>
          <div className='flex items-center gap-3 mb-2'>
            <h3 className='text-lg font-bold text-gray-900'>
          ...
          <p className='text-sm text-gray-500 mb-1'>
            The constitutional structure through which Opportunity Science™ discovers, evaluates, coordinates, and measures enterprise opportunity.
          </p>
          <p className='text-xs text-gray-400 italic mb-4'>
            Opportunity is not value. Discovery is not execution. Execution is not realization. Value must be demonstrated through measurable evidence.
          </p>
          <div className="space-y-3">
            {principles.filter(p => ['TI-075', 'TI-076', 'TI-077'].includes(p.id)).map((p) => (
              <div key={p.id} className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-5 py-3">
                <div className="flex items-center gap-3">
                  <span className="font-mono text-sm font-bold text-slate-700">{p.id}</span>
                  <span className="text-sm font-semibold text-slate-800">{p.name}</span>
      ...
      <section className="mx-auto max-w-4xl px-6 pt-12 pb-0">
        <div className='mb-10'>
          ...
          <p className='text-sm text-gray-500 mb-1'>
            The constitutional principles governing how organizations reduce uncertainty through evidence — the missing bridge between Opportunity Science™ and Transformation Intelligence™.
          </p>
          <p className='text-xs text-gray-400 italic mb-4'>
            Activity shall never be treated as evidence. Opinion shall never be treated as validation. Validation occurs only when observable evidence reduces material uncertainty.
          </p>
          <p className='text-xs text-gray-400 mb-4'>
            Constitutional cycle: Opportunity → Validation → Transformation → Measurement → Learning → New Opportunity
          </p>
          <div className="space-y-3">
            {principles.filter(p => ['TI-080'].includes(p.id)).map((p) => (
              <div key={p.id} className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-5 py-3">
                <div className="flex items-center gap-3">
                  <span className="font-mono text-sm font-bold text-slate-700">{p.id}</span>
                  <span className="text-sm font-semibold text-slate-800">{p.name}</span>
