        ...
        <section className="border-t border-slate-200 pt-6">
          ...
          <div className="space-y-1 mb-4">
            <p className="text-[10px] text-slate-400">
              <a href="/constitution/ti-023" className="font-mono hover:underline" style={{ color: '#E05A00' }}>[TI-023]</a>{' '}
              Buyer Evidence Principle™
            </p>
            <p className="text-[10px] text-slate-400">
              <a href="/constitution/ti-024" className="font-mono hover:underline" style={{ color: '#E05A00' }}>[TI-024]</a>{' '}
              Buyer Evidence Score™
            </p>
            <p className="text-[10px] text-slate-400">
              <a href="/constitution/ti-025" className="font-mono hover:underline" style={{ color: '#E05A00' }}>[TI-025]</a>{' '}
              Underwriteability Index™
            </p>
          </div>
