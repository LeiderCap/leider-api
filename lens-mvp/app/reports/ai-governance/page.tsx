...
function AIGovernancePageInner() {
  ...
  async function handleGenerate() {
    ...
    setError('');
    try {
      const successUrl = `${window.location.origin}/reports/ai-governance/result?ticker=${encodeURIComponent(selected.ticker)}&company=${encodeURIComponent(selected.name)}&session_id={CHECKOUT_SESSION_ID}`;
      const cancelUrl = `${window.location.origin}/reports/ai-governance`;
      ...
      <section className="section pt-16 pb-20">
        <div className="section-inner mx-auto max-w-2xl">
          ...
          <div className="mb-8 flex items-center gap-2 text-sm text-slate-400">
            ...
            <span>/</span>
            <span className="text-slate-600">AI Governance Report™</span>
          </div>
          ...
          <div className="mb-8">
            ...
            <h1 className="mt-3 text-3xl font-bold leading-tight">
              Can this organization govern its AI?
            </h1>
            <p className="mt-3 text-slate-500 leading-7">
              Assess AI governance readiness across four critical dimensions — board-ready output
          ...
          <div className="mb-8 rounded-2xl border border-slate-100 bg-slate-50 p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {[
                ...
                'Board-ready summary',
                'Top governance risks + board actions',
          ...
          <div className="rounded-2xl border border-blue-200 bg-blue-50 p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-slate-500">one-time · board-ready output</p>
              </div>
            ...
            >
              {checkoutLoading ? 'Redirecting to checkout…' : 'Generate AI Governance Report →'}
            </button>
          ...
          <p className="mt-6 text-xs text-slate-400 text-center">
            AI Governance Report™ reflects governance indicators based on publicly available signals.
            Not investment advice or a regulatory assessment.
          </p>
        </div>
      </section>
    </main>
