...
export default function InvestorStackRequestPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setErrorMsg('');
    try {
      const res = await fetch('/api/investor-stack-request', {
        method: 'POST',
      ...
      <section className="section pt-16 pb-20">
        <div className="section-inner mx-auto max-w-2xl">
          ...
          <div className="mb-8 flex items-center gap-2 text-sm text-slate-400">
            ...
            <span>/</span>
            <Link href="/enterprise/investor-stack" className="hover:text-slate-600 transition-colors">Investor Stack™</Link>
            <span>/</span>
          ...
          <div className="mb-8">
            ...
            <h1 className="mt-3 text-3xl font-bold leading-tight">
              Request an Investor Stack™ Assessment
            </h1>
