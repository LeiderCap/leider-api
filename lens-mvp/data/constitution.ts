...
export const principles: Principle[] = [
...

  {
    id: 'TI-075',
    slug: 'ti-075',
    name: 'Enterprise Value Architecture™',
    status: 'Ratified',
    version: '1.0',
    published: '2026-07-02',
    author: 'Stephen F. Leider',
    ...
    oid: 'OID-2026-TI-EVA-001',
    lensUri: 'lens://constitution/ti-075',
    principle: 'The Enterprise Value Architecture establishes the constitutional structure through which Opportunity Science™ discovers, evaluates, coordinates, and measures enterprise opportunity. Each layer depends upon the integrity of the layer preceding it. Opportunity is not value. Discovery is not execution. Execution is not realization. Only measurable outcomes constitute value realization.',
    definition: 'The Enterprise Value Architecture consists of five constitutional layers: Layer I Opportunity Science™ — the governing scientific discipline responsible for discovering, evaluating, and validating enterprise opportunity. Primary question: What opportunity exists? Layer II The Lens™ — the enterprise intelligence engine that analyzes enterprise evidence, identifies hidden opportunities, evaluates transformation potential, and produces structured assessments. Primary question: Where is the opportunity? Layer III Opportunity Types — the classification framework that organizes enterprise opportunities according to the primary mechanism of value creation (Capital Allocation, Enterprise Trust, AI Transformation, Governance, Workforce Transformation, Operating Model, Portfolio Simplification, Customer Value, Innovation, Digital Infrastructure, Organizational Capability). Primary question: What kind of opportunity is this? Layer IV Enterprise Value Engine™ — the execution architecture that explains the causal system through which an enterprise converts capabilities, decisions, execution, and learning into durable enterprise value. Identifies structural forces, enterprise capabilities, economic mechanisms, reinforcing relationships, decision architecture, capital allocation, organizational execution, and continuous learning. The Enterprise Value Engine explains why the enterprise creates value and how leadership can intentionally strengthen that system over time. Primary question: How is opportunity converted into enterprise value? Layer V Value Realization — the measurement layer that determines whether enterprise value has actually been created through observable evidence and disciplined measurement. Primary question: Was value actually created?',
    operatingLaw: 'Constitutional Laws: Opportunity is not value. Discovery is not execution. Execution is not realization. Only measurable outcomes constitute value realization. Constitutional sequence: Opportunity Science™ discovers. The Lens™ reveals. Opportunity Types classify. The Enterprise Value Engine™ explains and coordinates enterprise value creation. Value Realization measures outcomes. Equity Reclamation™ is formally positioned as a specialized application within the Value Realization layer — its purpose is to identify, quantify, and unlock unrealized shareholder value through coordinated improvements in capital allocation, governance, strategic positioning, enterprise execution, organizational capability, operational performance, and transformation effectiveness.',
    implications: [
      'Five-Layer Constitutional Architecture with primary questions: Layer I Opportunity Science™ (What opportunity exists?). Layer II The Lens™ (Where is the opportunity?). Layer III Opportunity Types (What kind of opportunity is this?). Layer IV Enterprise Value Engine™ (How is opportunity converted into enterprise value?). Layer V Value Realization (Was value actually created?).',
      'Layer IV — Enterprise Value Engine™ refined definition: Explains the causal system through which an enterprise converts capabilities, decisions, execution, and learning into durable enterprise value. Identifies: structural forces, enterprise capabilities, economic mechanisms, reinforcing relationships, decision architecture, capital allocation, organizational execution, continuous learning. Does not merely execute strategy — it explains why the enterprise creates value and how leadership can intentionally strengthen that system over time.',
      'Equity Reclamation™ formal repositioning: Positioned as a specialized application within the Value Realization layer (Layer V). Purpose: identify, quantify, and unlock unrealized shareholder value through capital allocation, governance, strategic positioning, enterprise execution, organizational capability, operational performance, and transformation effectiveness. This repositioning preserves Equity Reclamation™ as an important application while allowing Opportunity Science to extend naturally across public companies, private enterprises, healthcare organizations, industrial businesses, financial institutions, governments, and nonprofit organizations.',
      'Constitutional separation established: This architecture formally separates scientific discovery from enterprise application — transforming Opportunity Science from a collection of analytical methods into a coherent discipline capable of producing consistent Enterprise Value Blueprints across industries, ownership models, and organizational contexts.',
      'Griffin Blueprint application: Enterprise opportunities are discovered through The Lens™, organized through Opportunity Types, evaluated through the Enterprise Value Engine™, prioritized through the Enterprise Value Frontier™, and measured through Value Realization. Every recommendation remains traceable to evidence. Every outcome remains measurable.',
      'Founding significance: The Enterprise Value Architecture establishes a clear constitutional separation between scientific discovery and enterprise application. Beginning with Enterprise Value Blueprint™ No. 001 — Griffin Fluid Management, every future Blueprint shall apply this architecture to ensure methodological consistency, analytical rigor, and cumulative learning across the Opportunity Science Library.',
      'Opportunity Types — illustrative classifications: Capital Allocation, Enterprise Trust, AI Transformation, Governance, Workforce Transformation, Operating Model, Portfolio Simplification, Customer Value, Innovation, Digital Infrastructure, Organizational Capability.',
    ],
    typedRelationships: [
      {
        type: 'extends',
        targetId: 'TI-065',
        description: 'Extends Opportunity Science™ Ontology — EVA™ provides the five-layer constitutional structure within which the nine-step ontology operates',
      },
      {
        type: 'extends',
        targetId: 'TI-021',
        description: 'Extends Enterprise Intelligence Architecture Principle™ — EVA™ applies EIA™ specifically to the enterprise value creation sequence',
      },
      {
        type: 'implements',
        targetId: 'TI-044',
        description: 'Implements Divergence Acceleration Law™ — the five-layer architecture is the organizational system through which DAL™ compounding advantage is operationally achieved',
      },
      {
        type: 'implements',
        targetId: 'TI-013',
        description: 'Implements Conservation of Enterprise Value™ Law — Constitutional Law 1 (Opportunity is not value) and Law 3 (Execution is not realization) are direct applications of TI-013',
      },
      {
        type: 'enables',
        targetId: 'TI-801',
        description: 'Enables Equity Reclamation™ — formally positions Equity Reclamation™ within the Value Realization layer of the constitutional architecture',
      },
      {
        type: 'depends_on',
        targetId: 'TI-072',
        description: 'Depends on Founding Resolution™ — ratified as part of Version 1.0 Standard governing the Griffin Blueprint engagement',
      },
    ],
    relatedIds: [
      'TI-065', 'TI-021', 'TI-044',
      'TI-013', 'TI-801', 'TI-072',
      'TI-066', 'TI-103', 'TI-025',
    ],
  },

  {
    ...
    categoryCode: 'TI-CONST',
    book: 'Book XIX — Enterprise Value Architecture™',
    oid: 'OID-2026-TI-EI-001',
    lensUri: 'lens://constitution/ti-076',
    principle: 'Opportunity Science produces two classes of outputs: Knowledge Artifacts (improve enterprise understanding) and Enterprise Instruments (improve enterprise governance). Understanding without measurement cannot reliably improve decision-making. Measurement without understanding lacks strategic meaning. Every Enterprise Value Blueprint™ shall produce both. Organizations rarely fail because they lack information — they fail because they lack disciplined instruments for governing what matters most.',
    definition: 'Enterprise Instruments™ enable leadership to govern the enterprise by transforming enterprise judgment into observable management practice. They answer: How should leadership measure whether enterprise value is actually being created? Unlike reports, Enterprise Instruments are designed for continuous use. Knowledge Artifacts answer: What should leadership understand? Knowledge Artifacts include: Enterprise Examination™, Enterprise Findings™, Enterprise Value Engine™, Enterprise Value Frontier™, Executive Transformation Plan™, Executive Opinion™. Eight canonical Enterprise Instruments: Enterprise Value Dashboard™ (monitors Enterprise Value Engine health — primary user: Board of Directors), Value Realization Scorecard™ (measures whether expected enterprise value is becoming observable reality — primary user: Executive Leadership Team), Executive Decision Register™ (captures consequential strategic decisions with rationale, expected outcomes, assumptions, and results — primary user: CEO and Executive Committee), Enterprise Capability Index™ (measures maturity and strength of capabilities supporting the Enterprise Value Engine — primary user: CEO), Transformation Capacity Index™ (measures ability to absorb additional strategic change without degrading execution quality — primary user: Executive Leadership Team), Enterprise Trust Index™ (measures accumulated operational trust across customers, partners, employees, and stakeholders — primary user: CEO and Board), Operational Intelligence Index™ (measures how effectively operational knowledge is captured, reused, and converted into enterprise capability — primary user: Operations Leadership), Enterprise Judgment Index™ (measures quality, consistency, transparency, and learning effectiveness of significant enterprise decisions — primary user: Executive Leadership Team).',
    operatingLaw: 'Principle of Instrumentation: Every significant Finding should eventually correspond to one or more Enterprise Instruments. If a conclusion cannot be monitored over time, leadership cannot determine whether enterprise value is improving. Instrumentation transforms Opportunity Science from periodic analysis into continuous enterprise stewardship. Principle of Evidence: Enterprise Instruments measure observable evidence — capability strength, customer outcomes, decision quality, knowledge reuse, trust accumulation, revenue quality, strategic relevance, value realization. Activity alone should never be interpreted as enterprise progress. Principle of Governance: Enterprise Instruments exist to improve executive judgment — not reporting. Each Instrument supports board oversight, executive prioritization, capital allocation, transformation governance, and long-term enterprise stewardship.',
    implications: [
      'Complete constitutional architecture sequence: Opportunity Science™ → The Lens™ → Opportunity Types → Enterprise Value Engine™ → Enterprise Value Frontier™ → Executive Transformation Plan™ → Enterprise Instruments™ → Value Realization™. This establishes the complete constitutional architecture from discovery through governance and measurable outcomes.',
      'Eight canonical Enterprise Instruments and primary users: Enterprise Value Dashboard™ (Board of Directors). Value Realization Scorecard™ (Executive Leadership Team). Executive Decision Register™ (CEO and Executive Committee). Enterprise Capability Index™ (CEO). Transformation Capacity Index™ (Executive Leadership Team). Enterprise Trust Index™ (CEO and Board). Operational Intelligence Index™ (Operations Leadership). Enterprise Judgment Index™ (Executive Leadership Team).',
      'Relationship to Griffin Blueprint: Every significant Finding in the Griffin Enterprise Value Blueprint™ shall correspond to one or more Enterprise Instruments from this canonical set. This ensures that Griffin leadership receives not only enterprise understanding but also the governance tools required to measure whether value is actually being created over time.',
      'Founding Principle: Enterprise Instruments translate enterprise judgment into observable evidence, disciplined governance, and measurable Value Realization. They represent the operational expression of Opportunity Science — the mechanism through which understanding becomes stewardship.',
      'Instrumentation principle applied: Every Enterprise Finding Standard™ (TI-073) Finding that cannot be monitored over time through an Enterprise Instrument is constitutionally incomplete. The Finding identifies the opportunity; the Instrument measures whether it is being realized.',
    ],
    typedRelationships: [
      {
        type: 'extends',
        targetId: 'TI-075',
        description: 'Extends Enterprise Value Architecture™ — Enterprise Instruments™ are the measurement layer completing the five-layer EVA™ constitutional architecture at Layer V Value Realization',
      },
      {
        type: 'implements',
        targetId: 'TI-058',
        description: 'Implements Measurement Integrity Principle™ — each Enterprise Instrument applies MI™ to a specific dimension of enterprise performance',
      },
      {
        type: 'implements',
        targetId: 'TI-073',
        description: 'Implements Enterprise Finding Standard™ — every Finding must correspond to one or more Enterprise Instruments per the Principle of Instrumentation',
      },
      {
        type: 'implements',
        targetId: 'TI-016',
        description: 'Implements Continuous Learning Law™ — Enterprise Instruments transform Opportunity Science from periodic analysis into continuous enterprise stewardship',
      },
      {
        type: 'depends_on',
        targetId: 'TI-072',
    ...
    relatedIds: [
      'TI-075', 'TI-058', 'TI-073',
      'TI-016', 'TI-072', 'TI-068',
      'TI-071', 'TI-069',
    ],
  },

  {
    ...
    definition: 'The Enterprise Record™ is the persistent, evidence-based institutional memory of an enterprise. It preserves the complete chain of enterprise judgment from discovery through Value Realization. Unlike traditional reports, which describe an enterprise at a moment in time, the Enterprise Record evolves continuously as new evidence, decisions, outcomes, and learning become available. It preserves: enterprise evidence, enterprise examinations, enterprise Findings, opportunity classifications, Enterprise Value Engines, Enterprise Value Frontiers, Executive Transformation Plans, executive decisions, Enterprise Instruments, Value Realization outcomes, lessons learned, future hypotheses, and subsequent revisions. The Enterprise Record is the enduring enterprise asset created by the Opportunity Science process.',
    ...
    implications: [
      'Complete constitutional sequence with Enterprise Record™: Opportunity Science™ (discovers) → The Lens™ (reveals evidence) → Opportunity Types (classify) → Enterprise Value Engine™ (explains value creation) → Enterprise Value Frontier™ (prioritizes) → Executive Transformation Plan™ (coordinates action) → Enterprise Instruments™ (measure performance) → Value Realization™ (determines outcomes) → Enterprise Record™ (preserves and compounds). This is the complete constitutional architecture from discovery through institutional learning.',
...

  {
    ...
    implications: [
      ...
      'Relationship to complete Enterprise Value Architecture: Opportunity Science™ (establishes the discipline) → The Lens™ (discovers opportunity) → Opportunity Types (organize opportunity) → Enterprise Value Engine™ (explains value creation) → Enterprise Value Frontier™ (prioritizes transformation) → Executive Transformation Plan™ (coordinates enterprise action) → Enterprise Instruments™ (govern enterprise evolution) → Value Realization™ (measures observable strengthening) → Enterprise Record™ (preserves cumulative learning). Collectively these constitutional elements enable disciplined enterprise evolution.',
...

  {
    id: 'TI-079',
    slug: 'ti-079',
    name: 'Principle of Enterprise Capability™',
    status: 'Ratified',
    version: '1.0',
    published: '2026-07-02',
    author: 'Stephen F. Leider',
    ...
    categoryCode: 'TI-CONST',
    book: 'Book I — Constitutional Governance',
    oid: 'OID-2026-TI-PEC-001',
    lensUri: 'lens://constitution/ti-079',
    principle: 'The ultimate output of the Opportunity Science process is not a recommendation, a report, or a transformation initiative. It is a stronger enterprise. Opportunities are discovered not for their own sake, but because they represent the potential to improve an enterprise\'s ability to create value over time. Every significant recommendation should contribute to at least one enduring enterprise capability.',
    definition: 'Enterprise Capability is the organization\'s demonstrated ability to consistently convert knowledge, decisions, resources, relationships, and execution into sustainable value creation. Enterprise capability is cumulative — it develops over time through disciplined learning, coordinated action, and measurable improvement. Capabilities may include: engineering capability, decision capability, governance capability, operational capability, customer capability, innovation capability, capital allocation capability, learning capability, institutional memory capability. The purpose of transformation is capability development rather than activity completion.',
    operatingLaw: 'Capability as the Unit of Progress: Projects begin and end. Technologies change. Strategies evolve. Markets shift. Capabilities endure. Opportunity Science evaluates long-term progress primarily through the strength of enterprise capabilities rather than the completion of individual initiatives. Constitutional distinction: Transformation Activity (the work performed) vs Capability Development (the strengthening of the enterprise) vs Value Realization (the measurable evidence that stronger capability has produced improved enterprise outcomes). This distinction preserves analytical clarity throughout the discipline.',
    implications: [
      'Relationship to Enterprise Evolution (TI-078): Enterprise evolution occurs through continuous strengthening of enterprise capability. Each completed cycle of discovery, understanding, prioritization, transformation, measurement, and learning should increase the enterprise\'s capacity to create future value. Capability is both the product of successful evolution and the foundation for future evolution.',
      'Relationship to Value Realization: Value Realization provides the observable evidence that enterprise capability has strengthened. Opportunity Science distinguishes: Transformation Activity (work performed), Capability Development (strengthening of the enterprise), Value Realization (measurable evidence that stronger capability produced improved outcomes).',
      'Relationship to Enterprise Record™ (TI-077): The Enterprise Record preserves the longitudinal history of capability development — how capabilities were identified, how they were strengthened, what evidence supported improvement, what outcomes resulted, and what was learned.',
      'Executive Evaluation Questions: Which enterprise capabilities became stronger? Which remained unchanged? Which weakened? What evidence supports that assessment? Which future opportunities are now possible because capability has improved? These questions shift executive attention from short-term activity toward long-term enterprise development.',
      'Founding Principle: Organizations do not become extraordinary because they complete more initiatives. They become extraordinary because they continuously strengthen the capabilities that allow them to create greater value with every successive cycle of learning. The discipline should be judged not by the quantity of its analyses, but by the degree to which enterprises become measurably more capable over time.',
      'Griffin Blueprint application: Every recommendation in the Griffin Blueprint should be evaluated against one question — which enterprise capability does this strengthen? Recommendations that strengthen no enduring capability should be deprioritized regardless of their short-term appeal. The Griffin Blueprint is successful when Griffin Fluid Management becomes measurably more capable, not merely when initiatives are completed.',
    ],
    typedRelationships: [
      {
        type: 'extends',
        targetId: 'TI-078',
        description: 'Extends Principle of Enterprise Evolution™ — PEC™ defines enterprise capability as the primary unit of progress through which intentional evolution is measured',
      },
      {
        type: 'extends',
        targetId: 'TI-004',
        description: 'Extends Transformation Capacity Principle™ — Enterprise Capability is the Opportunity Science expression of Transformation Capacity at the engagement level',
      },
      {
        type: 'implements',
        targetId: 'TI-077',
        description: 'Implements Enterprise Record™ — the Record preserves the longitudinal history of capability development as its primary content',
      },
      {
        type: 'implements',
        targetId: 'TI-076',
        description: 'Implements Enterprise Instruments™ — each canonical Instrument measures a specific dimension of enterprise capability development',
      },
      {
        type: 'implements',
        targetId: 'TI-073',
        description: 'Implements Enterprise Finding Standard™ — every Finding must contribute to at least one enduring enterprise capability per constitutional law',
      },
    ],
    relatedIds: [
      'TI-078', 'TI-004', 'TI-077',
      'TI-076', 'TI-073', 'TI-072',
      'TI-075', 'TI-011', 'TI-016',
    ],
  },

  // ============================================
  // VALIDATION SCIENCE (TI-080)
  // ============================================

  {
    id: 'TI-080',
    slug: 'ti-080',
    name: 'Validation Science™',
    status: 'Ratified',
    version: '1.0',
    published: '2026-07-02',
    author: 'Stephen F. Leider',
    ...
    category: 'Foundational Constitution',
    categoryCode: 'TI-CONST',
    book: 'Book XX — Validation Science™',
    oid: 'OID-2026-TI-VS-001',
    lensUri: 'lens://constitution/ti-080',
    principle: 'Validation Science™ establishes the constitutional principles governing how organizations reduce uncertainty through evidence. Every enterprise begins as a collection of hypotheses. Long-term enterprise value is created by systematically replacing hypotheses with observable evidence. Activity shall never be treated as evidence. Opinion shall never be treated as validation. Validation occurs only when observable evidence reduces material uncertainty.',
    definition: 'Validation Science™ provides the standards by which hypotheses are tested, learning is measured, and confidence is earned before resources, capital, or organizational commitment are deployed. Constitutional Statement: Validation is the disciplined reduction of uncertainty through observable evidence. Opportunity Science™ identifies where value may exist. Validation Science™ determines whether that value has been demonstrated through sufficient evidence. Transformation Intelligence™ coordinates how validated opportunities become measurable enterprise value. Together they establish a continuous constitutional cycle: Opportunity → Validation → Transformation → Measurement → Learning → New Opportunity.',
    operatingLaw: 'Constitutional Law: Organizations create durable value by replacing uncertainty with evidence. Interest initiates discovery. Commitment validates demand. Measured outcomes validate value. Complete measurement lifecycle: Opportunity Science™ measures potential. Validation Science™ measures confidence. Transformation Intelligence™ measures execution. Transformation Efficiency™ measures realized value.',
    implications: [
      'Article I — The Validation Principle™: Every enterprise begins as a collection of hypotheses. Long-term enterprise value is created by systematically replacing hypotheses with observable evidence. Activity shall never be treated as evidence. Opinion shall never be treated as validation. Validation occurs only when observable evidence reduces material uncertainty.',
      'Article II — The Evidence Principle™: Evidence shall be evaluated according to its ability to reduce uncertainty rather than its ability to confirm prior beliefs. Observable behavior shall take precedence over stated intention. Repeatable results shall take precedence over isolated outcomes. Independent validation shall take precedence over self-assessment.',
      'Article III — Domains of Validation™ (three complementary domains): Scientific Validation™ — determines whether an underlying hypothesis is technically or empirically valid. Methods: controlled experiments, historical backtesting, predictive testing, replication, statistical validation. Output: Scientific Credibility™. Commercial Validation™ — determines whether stakeholders change behavior because of the evidence produced. Observable evidence: methodology review, internal circulation, technical evaluation, shadow tracking, pilot engagement, commercial agreement, renewal. Output: Commercial Credibility™. Enterprise Validation™ — determines whether implementation creates measurable organizational value. Evidence: adoption, Transformation Efficiency™, decision quality, organizational learning, financial performance, value realization. Output: Enterprise Credibility™.',
      'Article IV — Commitment Principle™: Interest is an opinion. Commitment is evidence. Observable commitments represent progressively stronger evidence that stakeholders believe expected value exceeds perceived risk. Organizations shall measure commitments rather than stated enthusiasm.',
      'Article V — Commitment Ladder™: Operationalizes Commercial Validation. Each successive level represents increasing organizational investment and decreasing commercial uncertainty. Nine-stage progression: 1. Information Request. 2. Methodology Review. 3. Internal Circulation. 4. Technical Evaluation. 5. Prospective Evaluation. 6. Paid Pilot. 7. Internal Sponsorship. 8. Operational Adoption. 9. Expansion and Renewal. Organizations may adapt specific stages to their context while preserving the constitutional principle that each stage requires a greater observable commitment than the previous.',
      'Article VI — Evidence Architecture™ (hierarchy from weakest to strongest): Opinion → Interest → Conversation → Information Request → Methodology Review → Internal Evaluation → Pilot → Commercial Agreement → Operational Adoption → Measured Value Creation. Organizations should make decisions using the strongest available evidence.',
      'Article VII — Validation Metrics™: Evidence Velocity™ (rate at which meaningful uncertainty is reduced through observable evidence). Commitment Conversion™ (percentage of stakeholders progressing from one commitment stage to the next). Commitment Friction™ (organizational, technical, financial, or governance barriers preventing progression). Validation Cycle Time™ (elapsed time from hypothesis to validated evidence). Validation Coverage™ (proportion of material hypotheses supported by sufficient evidence).',
      'Article VIII — The Validation Dashboard™: Organizations shall maintain a Validation Dashboard tracking: material hypotheses, evidence collected, commitment stage, validation metrics, friction points, outstanding uncertainties, next experiments. The dashboard exists to improve organizational learning rather than to measure activity alone.',
      'Article IX — Evidence-Based Governance™: Leadership shall allocate resources according to validated evidence rather than assumptions. Material decisions should identify: the hypothesis being tested, the evidence currently available, the uncertainty remaining, the next experiment required, the decision threshold for action. Validation shall become an ongoing governance discipline rather than a one-time milestone.',
      'Article X — Constitutional Relationship: Validation Science™ closes the gap between Opportunity Science™ (where value resides) and Transformation Intelligence™ (how value is realized). The complete constitutional cycle: Opportunity → Validation → Transformation → Measurement → Learning → New Opportunity. This is the missing bridge that completes the measurement philosophy of the discipline.',
    ],
    typedRelationships: [
      {
        type: 'extends',
        targetId: 'TI-061',
        description: 'Extends Validation Principle™ — TI-080 provides the complete ten-article constitutional framework of which TI-061 is the foundational principle',
      },
      {
        type: 'extends',
        targetId: 'TI-062',
        description: 'Extends Lens Validation Engine™ — TI-080 governs the constitutional standards that LVE™ implements technically',
      },
      {
        type: 'extends',
        targetId: 'TI-065',
        description: 'Extends Opportunity Science™ Ontology — Validation Science™ provides the confidence measurement layer between Opportunity Discovery and Transformation execution',
      },
      {
        type: 'implements',
        targetId: 'TI-015',
        description: 'Implements Evidence Sufficiency Law™ — the Evidence Architecture™ hierarchy and Evidence-Based Governance™ are constitutional expressions of TI-015 at the discipline level',
      },
      {
        type: 'implements',
        targetId: 'TI-016',
        description: 'Implements Continuous Learning Law™ — the Validation Dashboard™ and constitutional cycle (Opportunity → Validation → Transformation → Measurement → Learning) operationalize TI-016',
      },
      {
        type: 'depends_on',
        targetId: 'TI-078',
        description: 'Depends on Principle of Enterprise Evolution™ — Validation Science™ is the mechanism through which intentional enterprise evolution is earned rather than assumed',
      },
    ],
    relatedIds: [
      'TI-061', 'TI-062', 'TI-065',
      'TI-015', 'TI-016', 'TI-078',
      'TI-058', 'TI-073', 'TI-075',
    ],
  },
